...
let img1 = document.querySelector('.img_exploded')
let img2 = document.querySelector('.img2')
let img3 = document.querySelector('.img3')
let img4 = document.querySelector('.img4')


let imgs = [ /*'car0.png' ,*/ 'a1.jpg' , 'a2.jpg' , 'a3.jpg' , 'p01.png']
let index = 0 ;
...
btn_next.addEventListener('click', function(){
    ...
    img1.src = imgs[index]
    if( imgs[index] === 'car0.png' ){
        img1.classList.remove('img1_small')
        img1.className = 'img1'
    } else {
        img1.classList.add('img1_small')
    }
    if( imgs[index] === 'p01.png' ){
        img1.classList.remove('img1_small')
        img1.classList.add('img_exploded')
    } else{
        img1.classList.remove('img_exploded')
    }
    index++ ;
